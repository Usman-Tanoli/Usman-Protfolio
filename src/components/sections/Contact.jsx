...
export const Contact=()=>{
    ...
    return <section 
    id="contacts" 
    className="min-h-screen max-w-screen flex items-end justify-center py-20 mx-auto relative left-10">
        <RevealOnScroll>
            <div className="px-4 w-150">
                <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent text-center">
               {''} Get In Touch</h2>
                <form onSubmit={handleSubmit} className="space-y-6 bg-sky-700 p-10 rounded-3xl w-[400px] mx-auto md:w-full">
